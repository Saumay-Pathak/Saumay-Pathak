...
I'm a **Full Stack Software Developer** passionate about building scalable web applications, SaaS platforms, and high-performance backend systems.

- 🔭 Currently building **SaaS platforms** and **multi-tenant architectures**
- 🌱 Deepening expertise in **Golang** for high-performance backend services
- 🤝 Open to **collaborations** on SaaS and backend systems
- 💼 Available for **freelance projects**
- ⚡ Fun fact: I love architecting complex backend systems and SaaS platforms from scratch
...
| Domain | Skills |
|---|---|
| **Backend** | PHP/Laravel, Golang, Node.js, REST API Design |
| **Frontend** | React.js, Next.js, TypeScript, TailwindCSS |
| **Architecture** | SaaS Multi-Tenant Systems, Microservices, System Design |
| **Database** | MySQL, PostgreSQL, MongoDB, Redis, Query Optimization |
| **DevOps** | Docker, CI/CD, VPS Deployment, Linux, Nginx |
| **Security** | JWT Auth, Secure API Development, OAuth |
...
💼 **Open for Freelance Development Work** · 🌐 [saumaypathak.in](https://saumaypathak.in)

*"Building high-performance scalable systems, one architecture at a time."*
